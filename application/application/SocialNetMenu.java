...
public class SocialNetMenu {
    ...
    public HBox getMenu(){
		...
		MenuItem u3 = new MenuItem("Show All Users");
        ...
        //refactor label
        //good to have but probably belongs in the bottom pane
        //I pulled the label text out as a string
        //then print to the console for debugging
